...
class HexagonInstructionInfo {
	...
	static {
		...
		dot_new_producers.put("L2_ploadrubt_io", 1);
		dot_new_producers.put("L2_ploadrubt_pi", 1);
		dot_new_producers.put("L2_ploadrubf_io", 1);
		dot_new_producers.put("L2_ploadrubf_pi", 1);
		dot_new_producers.put("L2_ploadrubtnew_io", 1);
		dot_new_producers.put("L2_ploadrubfnew_io", 1);
		dot_new_producers.put("L4_ploadrubt_rr", 1);
		dot_new_producers.put("L4_ploadrubf_rr", 1);
		dot_new_producers.put("L4_ploadrubtnew_rr", 1);
		dot_new_producers.put("L4_ploadrubfnew_rr", 1);
		dot_new_producers.put("L2_ploadrubtnew_pi", 1);
		dot_new_producers.put("L2_ploadrubfnew_pi", 1);
		dot_new_producers.put("L4_ploadrubt_abs", 1);
		dot_new_producers.put("L4_ploadrubf_abs", 1);
		dot_new_producers.put("L4_ploadrubtnew_abs", 1);
		dot_new_producers.put("L4_ploadrubfnew_abs", 1);
		dot_new_producers.put("L4_loadrb_rr", 0);
		dot_new_producers.put("L2_ploadrbt_io", 1);
		dot_new_producers.put("L2_ploadrbt_pi", 1);
		dot_new_producers.put("L2_ploadrbf_io", 1);
		dot_new_producers.put("L2_ploadrbf_pi", 1);
		dot_new_producers.put("L2_ploadrbtnew_io", 1);
		dot_new_producers.put("L2_ploadrbfnew_io", 1);
		dot_new_producers.put("L4_ploadrbt_rr", 1);
		dot_new_producers.put("L4_ploadrbf_rr", 1);
		dot_new_producers.put("L4_ploadrbtnew_rr", 1);
		dot_new_producers.put("L4_ploadrbfnew_rr", 1);
		dot_new_producers.put("L2_ploadrbtnew_pi", 1);
		dot_new_producers.put("L2_ploadrbfnew_pi", 1);
		dot_new_producers.put("L4_ploadrbt_abs", 1);
		dot_new_producers.put("L4_ploadrbf_abs", 1);
		dot_new_producers.put("L4_ploadrbtnew_abs", 1);
		dot_new_producers.put("L4_ploadrbfnew_abs", 1);
		dot_new_producers.put("L4_loadruh_rr", 0);
		dot_new_producers.put("L2_ploadruht_io", 1);
		dot_new_producers.put("L2_ploadruht_pi", 1);
		dot_new_producers.put("L2_ploadruhf_io", 1);
		dot_new_producers.put("L2_ploadruhf_pi", 1);
		dot_new_producers.put("L2_ploadruhtnew_io", 1);
		dot_new_producers.put("L2_ploadruhfnew_io", 1);
		dot_new_producers.put("L4_ploadruht_rr", 1);
		dot_new_producers.put("L4_ploadruhf_rr", 1);
		dot_new_producers.put("L4_ploadruhtnew_rr", 1);
		dot_new_producers.put("L4_ploadruhfnew_rr", 1);
		dot_new_producers.put("L2_ploadruhtnew_pi", 1);
		dot_new_producers.put("L2_ploadruhfnew_pi", 1);
		dot_new_producers.put("L4_ploadruht_abs", 1);
		dot_new_producers.put("L4_ploadruhf_abs", 1);
		dot_new_producers.put("L4_ploadruhtnew_abs", 1);
		dot_new_producers.put("L4_ploadruhfnew_abs", 1);
		dot_new_producers.put("L4_loadrh_rr", 0);
		dot_new_producers.put("L2_ploadrht_io", 1);
		dot_new_producers.put("L2_ploadrht_pi", 1);
		dot_new_producers.put("L2_ploadrhf_io", 1);
		dot_new_producers.put("L2_ploadrhf_pi", 1);
		dot_new_producers.put("L2_ploadrhtnew_io", 1);
		dot_new_producers.put("L2_ploadrhfnew_io", 1);
		dot_new_producers.put("L4_ploadrht_rr", 1);
		dot_new_producers.put("L4_ploadrhf_rr", 1);
		dot_new_producers.put("L4_ploadrhtnew_rr", 1);
		dot_new_producers.put("L4_ploadrhfnew_rr", 1);
		dot_new_producers.put("L2_ploadrhtnew_pi", 1);
		dot_new_producers.put("L2_ploadrhfnew_pi", 1);
		dot_new_producers.put("L4_ploadrht_abs", 1);
		dot_new_producers.put("L4_ploadrhf_abs", 1);
		dot_new_producers.put("L4_ploadrhtnew_abs", 1);
		dot_new_producers.put("L4_ploadrhfnew_abs", 1);
		dot_new_producers.put("L4_loadri_rr", 0);
		dot_new_producers.put("L2_ploadrit_io", 1);
		dot_new_producers.put("L2_ploadrit_pi", 1);
		dot_new_producers.put("L2_ploadrif_io", 1);
		dot_new_producers.put("L2_ploadrif_pi", 1);
		dot_new_producers.put("L2_ploadritnew_io", 1);
		dot_new_producers.put("L2_ploadrifnew_io", 1);
		dot_new_producers.put("L4_ploadrit_rr", 1);
		dot_new_producers.put("L4_ploadrif_rr", 1);
		dot_new_producers.put("L4_ploadritnew_rr", 1);
		dot_new_producers.put("L4_ploadrifnew_rr", 1);
		dot_new_producers.put("L2_ploadritnew_pi", 1);
		dot_new_producers.put("L2_ploadrifnew_pi", 1);
		dot_new_producers.put("L4_ploadrit_abs", 1);
		dot_new_producers.put("L4_ploadrif_abs", 1);
		dot_new_producers.put("L4_ploadritnew_abs", 1);
		dot_new_producers.put("L4_ploadrifnew_abs", 1);
		dot_new_producers.put("L2_ploadrdt_pi", 2);
		dot_new_producers.put("L2_ploadrdf_pi", 2);
		dot_new_producers.put("L2_ploadrdtnew_pi", 2);
		dot_new_producers.put("L2_ploadrdfnew_pi", 2);
		dot_new_producers.put("S2_pstorerbt_pi", 1);
		dot_new_producers.put("S2_pstorerbf_pi", 1);
		dot_new_producers.put("S2_pstorerbtnew_pi", 1);
		dot_new_producers.put("S2_pstorerbfnew_pi", 1);
		dot_new_producers.put("S2_pstorerht_pi", 1);
		dot_new_producers.put("S2_pstorerhf_pi", 1);
		dot_new_producers.put("S2_pstorerhtnew_pi", 1);
		dot_new_producers.put("S2_pstorerhfnew_pi", 1);
		dot_new_producers.put("S2_pstorerft_pi", 1);
		dot_new_producers.put("S2_pstorerff_pi", 1);
		dot_new_producers.put("S2_pstorerftnew_pi", 1);
		dot_new_producers.put("S2_pstorerffnew_pi", 1);
		dot_new_producers.put("S2_pstorerit_pi", 1);
		dot_new_producers.put("S2_pstorerif_pi", 1);
		dot_new_producers.put("S2_pstoreritnew_pi", 1);
		dot_new_producers.put("S2_pstorerifnew_pi", 1);
		dot_new_producers.put("S2_pstorerdt_pi", 1);
		dot_new_producers.put("S2_pstorerdf_pi", 1);
		dot_new_producers.put("S2_pstorerdtnew_pi", 1);
		dot_new_producers.put("S2_pstorerdfnew_pi", 1);
		dot_new_producers.put("S2_pstorerinewt_pi", 1);
		dot_new_producers.put("S2_pstorerinewf_pi", 1);
		dot_new_producers.put("S2_pstorerinewtnew_pi", 1);
		dot_new_producers.put("S2_pstorerinewfnew_pi", 1);
		dot_new_producers.put("S2_pstorerbnewt_pi", 1);
		dot_new_producers.put("S2_pstorerbnewf_pi", 1);
		dot_new_producers.put("S2_pstorerbnewtnew_pi", 1);
		dot_new_producers.put("S2_pstorerbnewfnew_pi", 1);
		dot_new_producers.put("S2_pstorerhnewt_pi", 1);
		dot_new_producers.put("S2_pstorerhnewf_pi", 1);
		dot_new_producers.put("S2_pstorerhnewtnew_pi", 1);
		dot_new_producers.put("S2_pstorerhnewfnew_pi", 1);
		...
		dot_new_producers.put("C2_cmovenewit", 1);
		dot_new_producers.put("C2_cmovenewif", 1);
		dot_new_producers.put("C2_cmoveit", 1);
		dot_new_producers.put("C2_cmoveif", 1);
		...
		dot_new_producers.put("A2_paddt", 1);
		dot_new_producers.put("A2_paddf", 1);
		dot_new_producers.put("A2_paddtnew", 1);
		dot_new_producers.put("A2_paddfnew", 1);
		dot_new_producers.put("A2_psubt", 1);
		dot_new_producers.put("A2_psubf", 1);
		dot_new_producers.put("A2_psubtnew", 1);
		dot_new_producers.put("A2_psubfnew", 1);
		dot_new_producers.put("A2_paddit", 1);
		dot_new_producers.put("A2_paddif", 1);
		dot_new_producers.put("A2_padditnew", 1);
		dot_new_producers.put("A2_paddifnew", 1);
		dot_new_producers.put("A2_pxort", 1);
		dot_new_producers.put("A2_pxorf", 1);
		dot_new_producers.put("A2_pxortnew", 1);
		dot_new_producers.put("A2_pxorfnew", 1);
		dot_new_producers.put("A2_pandt", 1);
		dot_new_producers.put("A2_pandf", 1);
		dot_new_producers.put("A2_pandtnew", 1);
		dot_new_producers.put("A2_pandfnew", 1);
		dot_new_producers.put("A2_port", 1);
		dot_new_producers.put("A2_porf", 1);
		dot_new_producers.put("A2_portnew", 1);
		dot_new_producers.put("A2_porfnew", 1);
		dot_new_producers.put("A4_psxtbt", 1);
		dot_new_producers.put("A4_psxtbf", 1);
		dot_new_producers.put("A4_psxtbtnew", 1);
		dot_new_producers.put("A4_psxtbfnew", 1);
		dot_new_producers.put("A4_pzxtbt", 1);
		dot_new_producers.put("A4_pzxtbf", 1);
		dot_new_producers.put("A4_pzxtbtnew", 1);
		dot_new_producers.put("A4_pzxtbfnew", 1);
		dot_new_producers.put("A4_psxtht", 1);
		dot_new_producers.put("A4_psxthf", 1);
		dot_new_producers.put("A4_psxthtnew", 1);
		dot_new_producers.put("A4_psxthfnew", 1);
		dot_new_producers.put("A4_pzxtht", 1);
		dot_new_producers.put("A4_pzxthf", 1);
		dot_new_producers.put("A4_pzxthtnew", 1);
		dot_new_producers.put("A4_pzxthfnew", 1);
		dot_new_producers.put("A4_paslht", 1);
		dot_new_producers.put("A4_paslhf", 1);
		dot_new_producers.put("A4_paslhtnew", 1);
		dot_new_producers.put("A4_paslhfnew", 1);
		dot_new_producers.put("A4_pasrht", 1);
		dot_new_producers.put("A4_pasrhf", 1);
		dot_new_producers.put("A4_pasrhtnew", 1);
		dot_new_producers.put("A4_pasrhfnew", 1);
	...
	static {
		...
		dot_new_operands.put("S2_storerinew_io", 2);
		dot_new_operands.put("S2_storerinew_pi", 2);
		dot_new_operands.put("S4_storerinew_ap", 2);
		dot_new_operands.put("S2_storerinew_pr", 2);
		dot_new_operands.put("S4_storerinew_ur", 3);
		dot_new_operands.put("S2_storerinew_pbr", 2);
		dot_new_operands.put("S2_storerinew_pci", 3);
		dot_new_operands.put("S2_storerinew_pcr", 2);
		dot_new_operands.put("S2_storerbnew_io", 2);
		dot_new_operands.put("S2_storerbnew_pi", 2);
		dot_new_operands.put("S4_storerbnew_ap", 2);
		dot_new_operands.put("S2_storerbnew_pr", 2);
		dot_new_operands.put("S4_storerbnew_ur", 3);
		dot_new_operands.put("S2_storerbnew_pbr", 2);
		dot_new_operands.put("S2_storerbnew_pci", 3);
		dot_new_operands.put("S2_storerbnew_pcr", 2);
		dot_new_operands.put("S2_storerhnew_io", 2);
		dot_new_operands.put("S2_storerhnew_pi", 2);
		dot_new_operands.put("S4_storerhnew_ap", 2);
		dot_new_operands.put("S2_storerhnew_pr", 2);
		dot_new_operands.put("S4_storerhnew_ur", 3);
		dot_new_operands.put("S2_storerhnew_pbr", 2);
		dot_new_operands.put("S2_storerhnew_pci", 3);
		dot_new_operands.put("S2_storerhnew_pcr", 2);
		dot_new_operands.put("S4_storerinew_rr", 3);
		dot_new_operands.put("S2_pstorerinewt_io", 3);
		dot_new_operands.put("S2_pstorerinewt_pi", 3);
		dot_new_operands.put("S2_pstorerinewf_io", 3);
		dot_new_operands.put("S2_pstorerinewf_pi", 3);
		dot_new_operands.put("S4_pstorerinewt_rr", 4);
		dot_new_operands.put("S4_pstorerinewf_rr", 4);
		dot_new_operands.put("S4_pstorerinewtnew_io", 3);
		dot_new_operands.put("S4_pstorerinewfnew_io", 3);
		dot_new_operands.put("S4_pstorerinewtnew_rr", 4);
		dot_new_operands.put("S4_pstorerinewfnew_rr", 4);
		dot_new_operands.put("S2_pstorerinewtnew_pi", 3);
		dot_new_operands.put("S2_pstorerinewfnew_pi", 3);
		dot_new_operands.put("S4_pstorerinewt_abs", 2);
		dot_new_operands.put("S4_pstorerinewf_abs", 2);
		dot_new_operands.put("S4_pstorerinewtnew_abs", 2);
		dot_new_operands.put("S4_pstorerinewfnew_abs", 2);
		dot_new_operands.put("S4_storerbnew_rr", 3);
		dot_new_operands.put("S2_pstorerbnewt_io", 3);
		dot_new_operands.put("S2_pstorerbnewt_pi", 3);
		dot_new_operands.put("S2_pstorerbnewf_io", 3);
		dot_new_operands.put("S2_pstorerbnewf_pi", 3);
		dot_new_operands.put("S4_pstorerbnewt_rr", 4);
		dot_new_operands.put("S4_pstorerbnewf_rr", 4);
		dot_new_operands.put("S4_pstorerbnewtnew_io", 3);
		dot_new_operands.put("S4_pstorerbnewfnew_io", 3);
		dot_new_operands.put("S4_pstorerbnewtnew_rr", 4);
		dot_new_operands.put("S4_pstorerbnewfnew_rr", 4);
		dot_new_operands.put("S2_pstorerbnewtnew_pi", 3);
		dot_new_operands.put("S2_pstorerbnewfnew_pi", 3);
		dot_new_operands.put("S4_pstorerbnewt_abs", 2);
		dot_new_operands.put("S4_pstorerbnewf_abs", 2);
		dot_new_operands.put("S4_pstorerbnewtnew_abs", 2);
		dot_new_operands.put("S4_pstorerbnewfnew_abs", 2);
		dot_new_operands.put("S4_storerhnew_rr", 3);
		dot_new_operands.put("S2_pstorerhnewt_io", 3);
		dot_new_operands.put("S2_pstorerhnewt_pi", 3);
		dot_new_operands.put("S2_pstorerhnewf_io", 3);
		dot_new_operands.put("S2_pstorerhnewf_pi", 3);
		dot_new_operands.put("S4_pstorerhnewt_rr", 4);
		dot_new_operands.put("S4_pstorerhnewf_rr", 4);
		dot_new_operands.put("S4_pstorerhnewtnew_io", 3);
		dot_new_operands.put("S4_pstorerhnewfnew_io", 3);
		dot_new_operands.put("S4_pstorerhnewtnew_rr", 4);
		dot_new_operands.put("S4_pstorerhnewfnew_rr", 4);
		dot_new_operands.put("S2_pstorerhnewtnew_pi", 3);
		dot_new_operands.put("S2_pstorerhnewfnew_pi", 3);
		dot_new_operands.put("S4_pstorerhnewt_abs", 2);
		dot_new_operands.put("S4_pstorerhnewf_abs", 2);
		dot_new_operands.put("S4_pstorerhnewtnew_abs", 2);
		dot_new_operands.put("S4_pstorerhnewfnew_abs", 2);
		dot_new_operands.put("S2_storerinewgp", 1);
		dot_new_operands.put("S2_storerbnewgp", 1);
		dot_new_operands.put("S2_storerhnewgp", 1);
	}
